...
def blend_light_source_zj(in_image, out_image):
    ...
    blended_image = torch.stack([out1, out2, out3], dim=1) # torch.Size([1, 3, 512, 512])
    return blended_image.view(in_image.shape)