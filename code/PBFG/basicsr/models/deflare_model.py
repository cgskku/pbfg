...
from basicsr.metrics.ssim_loss import SSIM
...
class DeflareModel(SRModel):
    ...
    def optimize_parameters(self, current_iter):
        ...
        # ssim loss
        criterion = SSIM()
        l_ssim_flare = 1 - criterion(self.flare_hat, self.flare)
        l_ssim_base = 1 - criterion(self.deflare, self.gt)
        l_ssim = l_ssim_base + l_ssim_flare 
        l_total += 0.6*l_ssim
        loss_dict['l_ssim'] = 0.6*l_ssim
